...
// include: C:\Users\dhira\AppData\Local\Temp\tmpc93o0a6e.js
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/bgm.wav", "start": 0, "end": 12718158}, {"filename": "/assets/correct.wav", "start": 12718158, "end": 12737653}, {"filename": "/assets/font_arcade.ttf", "start": 12737653, "end": 12853661}, {"filename": "/assets/font_fps.ttf", "start": 12853661, "end": 13890245}, {"filename": "/assets/font_quiz.ttf", "start": 13890245, "end": 14926829}, {"filename": "/assets/jump.wav", "start": 14926829, "end": 14935469}, {"filename": "/assets/wrong.wav", "start": 14935469, "end": 14966767}], "remote_package_size": 14966767});

  })();

// end include: C:\Users\dhira\AppData\Local\Temp\tmpc93o0a6e.js
// include: C:\Users\dhira\AppData\Local\Temp\tmp0pery1j1.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\dhira\AppData\Local\Temp\tmp0pery1j1.js
// include: C:\Users\dhira\AppData\Local\Temp\tmpyetirlyz.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\dhira\AppData\Local\Temp\tmpyetirlyz.js
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['LoadDynamicConfig'] != 'undefined', 'missing Wasm export: LoadDynamicConfig');
  assert(typeof wasmExports['SetAudioState'] != 'undefined', 'missing Wasm export: SetAudioState');
  ...
  _LoadDynamicConfig = Module['_LoadDynamicConfig'] = createExportWrapper('LoadDynamicConfig', 1);
  _SetAudioState = Module['_SetAudioState'] = createExportWrapper('SetAudioState', 1);
